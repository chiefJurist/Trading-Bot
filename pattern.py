...
for i in range(2, len(ohlcv_data)):
    ...
    if (
        last_close > last_lowerband and second_last_close > second_last_lowerband and third_last_close < third_last_lowerband and second_last_close > second_last_open and last_close > last_open and third_last_close < third_last_open
    ):
    ...
    if (
        last_close < last_upperband and second_last_close < second_last_upperband and third_last_close > third_last_lowerband and second_last_close < second_last_open and last_close < last_open and third_last_close > third_last_open
    ):
        pattern_matches.append({
            'timestamp': current_timestamp,
            'type': 'Bearish',
