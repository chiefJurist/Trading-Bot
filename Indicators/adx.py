...
def calculate_adx(df, period=14):
    ...
    result = [
        [idx, row['timestamp'], {'close': row['close'], 'adx': adx_value}]
        for idx, (row, adx_value) in enumerate(zip(df.to_dict('records'), adx))
    ]
...
# Calculate ADX
adx_result = calculate_adx(ohlcv_data)
adx_result2 = calculate_adx(ohlcv_data2)

# Print the results
print("1 MINUTE CHART")
for entry in adx_result:
    print(entry)
print("")
print("5 MINUTE CHART")
for entry in adx_result2:
    print(entry)